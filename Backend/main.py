...
app = Flask(__name__, static_folder="C:/Users/eivin/PycharmProjects/Portefolio2", static_url_path="")
...
def page(path):
    ...
    return flask.send_from_directory('C:/Users/eivin/PycharmProjects/Portefolio2', path)
